...
if (digestCard && youtubeBtn) {
    digestCard.addEventListener('click', (e) => {
        // Don't navigate if YouTube button was clicked
        if (e.target === youtubeBtn || youtubeBtn.contains(e.target)) {
            return;
        }
    ...
    digestCard.style.cursor = 'pointer';
}
